...
| `page_number_snapshot` | INT UNSIGNED, nullable | CHECK `>=1` | Immutable 1-based canonical-PDF page when applicable; TXT/legacy values require fallback semantics |
...
| `source_locator_snapshot` | JSON, nullable | — | Immutable nullable ordered normalized-box locator; no dynamic URL |
