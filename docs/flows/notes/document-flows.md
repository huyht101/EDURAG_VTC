...
Visibility uses `action=hide|unhide`; delete uses the confirmed Python method/path. Remaining Python blockers are tracked in the Week 3 readiness document.
