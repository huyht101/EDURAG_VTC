...
- **LLM & Embedding**: Google Gemini (`models/gemini-3.5-flash`, `models/gemini-embedding-001`, 768 dimensions)
...
2. **Cấu hình môi trường:**
   ...
   File này chỉ dành cho chạy Python standalone. Integrated stack tại repository root dùng duy nhất root `.env` và inject từng biến qua Compose.
...
- **Canonical integration contract**: xem [`../docs/api/internal-rag-contract.md`](../docs/api/internal-rag-contract.md) tại repository root.
